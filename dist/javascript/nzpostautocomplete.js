(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.nzpostautocomplete = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var NZPostAutocomplete = function () {
  function NZPostAutocomplete(el, config) {
    var _this = this;

    _classCallCheck(this, NZPostAutocomplete);
    ...
    this.dropdown = new _dropdown2.default(this.input, this.config);

    this.search = (0, _lodash2.default)(this.search.bind(this), this.config.ajaxDelay);
  ...
  _createClass(NZPostAutocomplete, [{
    key: 'onKeyDown',
    ...
    value: function setInput(el) {
      ...
      if (typeof el === 'string') this.input = document.querySelector(el);else if (el.tagName && el.tagName.toLowerCase() === 'input') this.input = el;else throw new Error('1 arguement should be String or instance of Element with tagName input');
    }
  }, {
    key: 'bindInputEvents',
    ...
    value: function search(value) {
      ...
      var that = this;
      this.getResults(value).then(function (response) {
    ...
    key: 'getResults',
    value: function getResults(value) {
      return _axios2.default.get(this.config.source, {
        params: {
          q: value
        }
      });
  ...
  return NZPostAutocomplete;
}();

exports.default = NZPostAutocomplete;

},{"./dropdown":30,"axios":1,"lodash.debounce":27}],30:[function(require,module,exports){
'use strict';
...
var Dropdown = function () {
  ...
  _createClass(Dropdown, [{
    ...
    key: 'setupFieldMap',
    value: function setupFieldMap() {
      var fieldMap = this.baseElement.getAttribute('data-fields');
      // Check our fieldMap exists otherwise return
      if (typeof fieldMap !== 'string') return;
      var parsedFieldMap = JSON.parse(fieldMap.replace(/&quot;/g, '"'));
    ...
    key: 'getResults',
    value: function getResults(value) {
      return _axios2.default.get(this.source, {
        params: {
          q: value
        }
      });
    ...
    key: 'fillDetails',
    value: function fillDetails(details) {
    ...
    key: 'mapResults',
    value: function mapResults(details) {
      var _this = this;

      // Map values to fields;
      if (this.fields) {
        Object.keys(this.fields).forEach(function (field) {
          var fieldToSet = document.getElementById(field);
          if (_this.config.debug) console.debug('Found form field', fieldToSet);

          if (fieldToSet.tagName.toLowerCase() === 'div') {
            fieldToSet = document.getElementsByName(field)[0];
          }

          var valueToMatch = _this.fields[field];
          if (_this.config.debug) console.debug('Match NZ Address field for ' + valueToMatch);

          var value = details[valueToMatch];
          if (_this.config.debug) console.debug('Value matched for ' + valueToMatch + ': ' + value);
          if (_this.config.debug) console.debug('Filling field ' + fieldToSet + ' with ' + value);
    ...
    key: 'createElementsList',
    value: function createElementsList(items) {
    ...
    value: function showResults(data) {
      ...
      if (!data || data.length === 0) this.dropdown.appendChild(this.createEmptyMessage());else {
        var ul = this.createElementsList(data);
        this.dropdown.appendChild(ul);
        this.setActiveElement(ul.firstChild);
        this.onEnterClick = function () {
          return _this2.fetchDetails(_this2.activeElement.listRow);
        };
      }
    ...
    key: 'createEmptyMessage',
    value: function createEmptyMessage() {
    ...
    value: function setActiveElement(elem) {
